...
H4_TARGETS      := $(H41x_TARGETS)

ifeq ($(filter $(TARGET),$(VALID_TARGETS)),)
$(error Target '$(TARGET)' is not valid, must be one of $(VALID_TARGETS). Have you prepared a valid target.mk?)
endif

ifeq ($(filter $(TARGET), $(F4_TARGETS) $(F7_TARGETS) $(G4_TARGETS) $(H7_TARGETS) $(H4_TARGETS) $(SITL_TARGETS)),)
...
else ifeq ($(TARGET),$(filter $(TARGET), $(H4_TARGETS)))
TARGET_MCU := CH32H41x
