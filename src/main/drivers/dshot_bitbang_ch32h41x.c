...
const timerHardware_t bbTimerHardware[] = {
    ...
    DEF_TIM(TIM1,  CH1, NONE,  TIM_USE_NONE, 0, 8,  0),
    DEF_TIM(TIM1,  CH2, NONE,  TIM_USE_NONE, 0, 9,  0),
    DEF_TIM(TIM1,  CH3, NONE,  TIM_USE_NONE, 0, 10, 0),
    DEF_TIM(TIM1,  CH4, NONE,  TIM_USE_NONE, 0, 11, 0),

    DEF_TIM(TIM8,  CH1, NONE,  TIM_USE_NONE, 0, 8,  0),
    DEF_TIM(TIM8,  CH2, NONE,  TIM_USE_NONE, 0, 9,  0),
    DEF_TIM(TIM8,  CH3, NONE,  TIM_USE_NONE, 0, 10, 0),
    DEF_TIM(TIM8,  CH4, NONE,  TIM_USE_NONE, 0, 11, 0),
...
motorDevice_t *dshotBitbangDevInit(const motorDevConfig_t *motorConfig, uint8_t count)
{
    ...
    for (int motorIndex = 0; motorIndex < MAX_SUPPORTED_MOTORS && motorIndex < motorCount; motorIndex++) {
        ...
        bbMotors[motorIndex].iocfg = IO_CONFIG(DIR_OUT , GPIO_MODE_OUT_AF_PP, GPIO_SPEED_VERY_HIGH , bbPuPdMode);
