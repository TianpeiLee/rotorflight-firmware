...
const uartHardware_t uartHardware[UARTDEV_COUNT] = {
...
#ifdef USE_UART4
    {
        ...
        .reg = USART4,
#ifdef USE_DMA
        .rxDMAMuxId = DMAMUX_DMAREQ_ID_USART4_RX,
        .rxDMAResource = (dmaResource_t *)UART4_RX_DMA_CHANNEL,
        .txDMAMuxId = DMAMUX_DMAREQ_ID_USART4_TX,
...
#ifdef USE_UART5
    {
        ...
        .reg = USART5,
#ifdef USE_DMA
        .rxDMAMuxId = DMAMUX_DMAREQ_ID_USART5_RX,
        .rxDMAResource = (dmaResource_t *)UART5_RX_DMA_CHANNEL,
        .txDMAMuxId = DMAMUX_DMAREQ_ID_USART5_TX,
...
#ifdef USE_UART7
    {
        ...
        .reg = USART7,
#ifdef USE_DMA
        .rxDMAMuxId = DMAMUX_DMAREQ_ID_USART7_RX,
        .rxDMAResource = (dmaResource_t *)UART7_RX_DMA_CHANNEL,
        .txDMAMuxId = DMAMUX_DMAREQ_ID_USART7_TX,
    ...
    {
        .device = UARTDEV_8,
        .reg = USART8, //USE UART8 FOR PIN CONFIG
#ifdef USE_DMA
        .rxDMAMuxId = DMAMUX_DMAREQ_ID_USART8_RX,
        .rxDMAResource = (dmaResource_t *)UART8_RX_DMA_CHANNEL,
        .txDMAMuxId = DMAMUX_DMAREQ_ID_USART8_TX,
...
void uartIrqHandler(uartPort_t *s)
{
    ...
    if (USART_GetFlagStatus(s->USARTx, USART_FLAG_IDLE) == SET) {
        ...
        (void) s->USARTx->STATR;
        (void) s->USARTx->DATAR;
        USART_ClearFlag(s->USARTx, USART_FLAG_IDLE);
    }
}
