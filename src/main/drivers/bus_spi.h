...
#define SPI_IO_AF_SCK_CFG           IO_CONFIG(DIR_OUT, GPIO_MODE_OUT_AF_PP, GPIO_SPEED_VERY_HIGH, GPIO_PULL_NONE)
#define SPI_IO_AF_SCK_CFG_HIGH   IO_CONFIG(DIR_OUT, GPIO_MODE_OUT_AF_PP, GPIO_SPEED_VERY_HIGH, GPIO_PULL_UP)
...
#define SPI_IO_AF_MISO_CFG       IO_CONFIG(DIR_IN, GPIO_MODE_IN_FLOAT, GPIO_SPEED_VERY_HIGH, GPIO_PULL_NONE)
...
#elif defined(CH32H41x)
#define CHECK_SPI_RX_DATA_AVAILABLE(instance)  ((instance->STATR & SPI_I2S_FLAG_RXNE) == (SPI_I2S_FLAG_RXNE))
